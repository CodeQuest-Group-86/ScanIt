...
const FAQ = [
  ...
  },
  {
    ...
    a: "Our authenticity detection uses multiple signals including packaging patterns, brand markings, and seller verification data to provide a confidence score.",
  },
  {
    q: "How are prices updated?",
    a: "Prices are sourced from verified sellers and updated regularly. Nearby sellers' prices reflect their latest listings.",
  },
  {
        ...
        <View style={styles.contactCard}>
          ...
          <View style={styles.contactBtns}>
            <TouchableOpacity
              ...
              onPress={() => Linking.openURL("mailto:karldjansi123@gmail.com")}
            >
            ...
            <TouchableOpacity
              style={styles.contactBtn}
              onPress={() => Linking.openURL("https://wa.me/233207384908")}
            >
