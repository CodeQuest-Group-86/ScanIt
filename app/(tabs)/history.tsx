    ...
    <TouchableOpacity style={styles.card} onPress={onPress} activeOpacity={0.8}>
      ...
      <Image
        source={{
          uri:
            product.imageUrl ||
            `https://via.placeholder.com/80x80/E76F2E/FFFFFF?text=${product.brand?.[0] ?? "P"}`,
        }}
        style={styles.image}
      />
      ...
      <View style={styles.cardBody}>
        ...
        {bestSeller && (
          <View style={styles.sellerRow}>
            ...
            {bestSeller.location ? (
              <Text style={styles.sellerLocation}>· {bestSeller.location}</Text>
            ) : null}
            <View style={{ flex: 1 }} />
            <TouchableOpacity
            ...
            <TouchableOpacity
              onPress={() =>
                Linking.openURL(
                  `https://wa.me/${bestSeller.whatsapp?.replace("+", "")}`,
                )
              }
        ...
        <View style={styles.footerRow}>
          {product.sellers?.length > 1 && (
            <Text style={styles.moreText}>
              {product.sellers.length - 1} more seller
              {product.sellers.length > 2 ? "s" : ""}
            </Text>
          )}
