  ...
  return (
    <View style={styles.container}>
      ...
      <CameraView
        ...
        onBarcodeScanned={
          mode === "barcode" && !isAnalyzing ? handleBarcodeScanned : undefined
        }
      />
        ...
        <View style={styles.modeToggle}>
          ...
          {!isPremium && (
            <View
              style={[
                styles.quotaBadge,
                scansLeft === 0 && styles.quotaBadgeEmpty,
              ]}
            >
              <Ionicons
                name="scan-outline"
                size={10}
                color={scansLeft === 0 ? Colors.danger : Colors.white}
              />
              <Text
                style={[
                  styles.quotaText,
                  scansLeft === 0 && styles.quotaTextEmpty,
                ]}
              >
                {scansLeft === 0
                  ? "Limit reached"
      ...
      <View style={styles.scanArea} pointerEvents="none">
        <ScanBracket
          size={240}
          color={mode === "barcode" ? Colors.accent : Colors.primary}
        />
        <Animated.View
          style={[
            styles.scanLine,
            {
              backgroundColor:
                mode === "barcode" ? Colors.accent : Colors.primary,
      ...
      {error === "invalid_object" && !isAnalyzing && (
        ...
        >
          ...
          <Text style={styles.invalidText}>
            Can&apos;t identify object — try a clearer shot
          </Text>
        ...
        {mode === "photo" ? (
          ...
          <View style={styles.barcodeIndicator}>
            <Ionicons
              ...
              size={40}
              color={isAnalyzing ? Colors.accent + "60" : Colors.accent}
            />
